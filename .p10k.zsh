# Generated by Powerlevel10k configuration wizard on 2022-06-23 at 14:53 -03.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 24045.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, angled separators, slanted heads, sharp tails, 2 lines, solid, left frame,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Otherwise show the first 16 … the last .
      # Tip: To always show local branch name in full without truncation, delete the next line.
      (( $#branch > 32 )) && branch[15,-1]="…"  # <-- this line
